...
public class RelativeFormatDate {
    ...
    public static String getTime(Date date){
        ...
        String sb = "";
        long[] itimes = new long[]{24 * 60 * 60 * 1000L, 60 * 60 * 1000L, 60 * 1000, 1000L};
        String[] sunits = new String[]{"天前", "小时前", "分钟前", "刚刚"};
    ...
    public static void main(String[] args) throws ParseException {
        ...
        Date date = format.parse("2018-04-19 12:30");
